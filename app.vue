...
useHead({
  htmlAttrs: {
    class: 'bg-white antialiased js-focus-visible',
  },
  link: [
    {
      rel: 'icon',
      type: 'image/png',
      href: '//images.ctfassets.net/ewxi5bk4tlk4/7zGluFqrRs2vyfwTgyUy7C/2ec31953d8b55406373ddc15f67e15a5/dalle-2022-12-14-110308---a-robot-deep-in-thought-in-the-style-of-caravaggio.png?w=100',
    },
    {
      rel: 'stylesheet',
...
<template>
  ...
  >
    ...
    >
      ...
      <!-- social -->
      <section v-if="false" class="mt-10 lg:mt-12">
        <h2
  ...
  <!--  -->
  <footer
    class="border-t border-slate-200 bg-slate-50 py-10 pb-40 sm:py-16 sm:pb-32 lg:hidden"
  >
    <div class="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
      ...
      <h2
        class="mt-8 flex items-center font-mono text-sm font-medium leading-7 text-slate-900"
      >
        <svg
          aria-hidden="true"
          viewBox="0 0 11 12"
          class="h-3 w-auto fill-slate-300"
        >
          <path
