...
export type Article = Entry & {
  ...
  updateAudio?: Maybe<Scalars['Boolean']>;
};


/** [See type definition](https://app.contentful.com/spaces/ewxi5bk4tlk4/content_types/article) */
export type ArticleAudioArgs = {
...
/** [See type definition](https://app.contentful.com/spaces/ewxi5bk4tlk4/content_types/article) */
export type ArticleUpdateAudioArgs = {
  locale?: InputMaybe<Scalars['String']>;
};
...
export type ArticleFilter = {
  ...
  updateAudio?: InputMaybe<Scalars['Boolean']>;
  updateAudio_exists?: InputMaybe<Scalars['Boolean']>;
  updateAudio_not?: InputMaybe<Scalars['Boolean']>;
};
...
export enum ArticleOrder {
  ...
  UpdateAudioAsc = 'updateAudio_ASC',
  UpdateAudioDesc = 'updateAudio_DESC'
}
